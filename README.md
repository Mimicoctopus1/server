...
# Client Installation
In case you didn't read the description, this is a browser game, so use a browser. Check out the [compatability table](compatability.md) if you plan to play.
